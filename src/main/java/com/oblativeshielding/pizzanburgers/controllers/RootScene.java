 ...
 * 
 * <p>This class mediates interaction between GUI elements
...
public class RootScene {
  ...
  /**
   * Orders a meal with the given menu items.
   */
  ...
  /**
   * Cancels meal order and returns to main menu.
   */
  public void cancelOrder() {
    rootHBox.getChildren().set(0, mainMenu);
  }

  /** Prints receipt to text area. */
